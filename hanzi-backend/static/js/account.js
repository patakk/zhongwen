...
let dropdownTrigger = document.getElementById('wordListDropdown');
let dropdownMenu = document.getElementById('dropdown-options');
...
function initAccount() {
    ...
    currentGridPlotters = [];
    showAllPinyin = false;
    let keyss = Object.keys(wordlists_words);
    currentWordlist = keyss[0];
    dropdownTrigger = document.getElementById('wordListDropdown');
    dropdownMenu = document.getElementById('dropdown-options');
    addWordsInput = document.getElementById('newWords');
