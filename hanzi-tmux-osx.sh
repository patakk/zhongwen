...
# Backend (Flask)
tmux send-keys -t zhongweb 'cd /Users/paolo/zhongwen/hanzi-backend' C-m
sleep 0.3
tmux send-keys -t zhongweb 'poetry run python app.py' C-m

# Frontend (Vue)
tmux split-window -v -t zhongweb
tmux send-keys -t zhongweb.1 'cd /Users/paolo/zhongwen/hanzi-frontend' C-m
sleep 0.3
tmux send-keys -t zhongweb.1 'npm run dev' C-m

# Search backend
tmux split-window -h -t zhongweb.1
tmux send-keys -t zhongweb.2 'cd /Users/paolo/zhongwen/hanzi-search' C-m
sleep 0.3
