        ...
        <li>
          ...
          <div class="flashcard-guide">
            <div>
              ...
              <p style="margin-left:20px;">For character recognition,<a class="links" href="https://github.com/gugray/HanziLookupJS/tree/master">HanziLookupJS</a>by <a class="links" href="https://github.com/gugray">gugray</a> is used. It is based on Jordan Kiang's <a class="links" href="https://kiang.org/jordan/software/hanzilookup/">HanziLookupJS</a>, which is under <a class="links" href="https://www.gnu.org/licenses/gpl-3.0.html">GNU GPL</a></p>
              <br />
